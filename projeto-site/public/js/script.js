...
function changeTeam() {
    ...
    let id_img_members = [];
    let id_name_members = [];
    let imgs_members_sprint_1 = ['david','felipe','gabriel','jose','lucas','renato'];
    let names_members_sprint_1 = ['David Rafael', 'Felipe Kling','Gabriel Alvares','José Fabiano','Lucas Ferreira','Renato Paulino'];
    let imgs_members_sprint_2 = ['alexandre', 'arthur', 'christian','david'];
    let names_members_sprint_2 = ['Alexandre Junior', 'Arthur Loureano', 'Christian Raines','David Rafael'];
    ...
    if (sprint === 1) {
        ...
        members[6].style.display= 'flex'; 
        members[5].style.display= 'flex'; 
